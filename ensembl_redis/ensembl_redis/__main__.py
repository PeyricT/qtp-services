"""Ensembl ressources microservice

Usage:
  ensembl_redis service start [--rh=<redis_host> --rp=<redis_port>] [--port=<portNumber>]
  ensembl_redis service wipe [--rh=<redis_host> --rp=<redis_port>]
  ensembl_redis service add <xmlProteomeFile> [--rh=<redis_host> --rp=<redis_port> --as=<collection_name>]
